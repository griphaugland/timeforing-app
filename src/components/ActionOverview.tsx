      ...
      <CardContent className="p-0 text-2xl h-full mb-4 w-full flex flex-col justify-between font-extrabold">
        ...
        {isActive ? (
          <div className="text-foreground text-4xl font-extrabold max-w-[100%] flex gap-1">
            <span className="number-block">{time.hours}</span>
            <span>:</span>
            <span className="number-block">{time.minutes}</span>
            <span>:</span>
            <span className="number-block">{time.seconds}</span>
            <span>:</span>
            <span className="number-block">{time.millis}</span>
          </div>
        ) : (
